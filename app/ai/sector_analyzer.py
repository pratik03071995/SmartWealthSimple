...
class SectorAnalyzer:
    def __init__(self, use_local_llm: bool = True, model_name: str = "microsoft/DialoGPT-medium"):
        ...
        self.sector_hierarchy = {
            ...
            "Energy": {
                ...
                "growth_potential": "Medium",
                "risk_level": "High",
                "key_drivers": ["Energy transition", "Renewable adoption", "Electrification", "Climate policies"]
            },
            "Industrial": {
                "description": "Manufacturing, construction, aerospace, and industrial services",
                "subsectors": [
                    "Manufacturing",
                    "Aerospace & Defense",
                    "Construction",
                ...
                "growth_potential": "Medium",
                "risk_level": "Medium",
                "key_drivers": ["Infrastructure spending", "Automation", "Supply chain optimization", "Defense spending"]
            },
            "Materials": {
                "description": "Companies that extract and process raw materials",
                "subsectors": [
                    "Mining",
                    "Chemicals",
                    "Steel & Metals",
                ...
                "growth_potential": "Medium",
                "risk_level": "High",
                "key_drivers": ["Infrastructure development", "Green materials", "Supply chain security", "Circular economy"]
            },
            "Real Estate": {
                ...
                "growth_potential": "Medium",
                "risk_level": "Medium",
                "key_drivers": ["Urbanization", "E-commerce growth", "Remote work", "Aging population"]
            },
            "Communication Services": {
                ...
                "growth_potential": "Medium",
                "risk_level": "Medium",
                "key_drivers": ["5G deployment", "Content consumption", "Digital advertising", "Streaming growth"]
            },
            "Consumer Staples": {
                "description": "Companies that sell essential goods and services",
                "subsectors": [
                    "Food & Beverage",
                    "Household Products",
                    "Personal Care",
                ...
                "risk_level": "Low",
                "key_drivers": ["Population growth", "Premiumization", "Health consciousness", "E-commerce adoption"]
            },
            "Utilities": {
                ...
                "growth_potential": "Low",
                "risk_level": "Low",
                "key_drivers": ["Energy transition", "Grid modernization", "Electrification", "Regulatory support"]
            }
        }
    ...
    def _assess_growth_potential(self, sector: str, subsector: str) -> str:
        ...
        medium_growth = ["Financial Services", "Consumer Discretionary"]
